...
ActiveRecord::Schema.define(:version => 20140304012413) do
  ...
  add_index "ambassadors", ["event_id"], :name => "index_ambassadors_on_event_id"
  add_index "ambassadors", ["profile_id"], :name => "index_ambassadors_on_profile_id"
  ...
  create_table "volunteer_positions", :force => true do |t|
    t.integer  "event_id"
    t.integer  "role_id"
    t.integer  "needed_count", :default => 1
    t.datetime "created_at",                  :null => false
    t.datetime "updated_at",                  :null => false
  end
